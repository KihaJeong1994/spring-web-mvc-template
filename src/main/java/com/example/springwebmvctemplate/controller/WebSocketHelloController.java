...
public class WebSocketHelloController {
    ...
    public void helloToOne(@Header("simpSessionId") String sessionId){
        messagingTemplate.convertAndSendToUser(sessionId,"/topic/hello",sessionId+", nice to meet you only!",createHeaders(sessionId)); // destination automatically set to /user/topic/hello (user destination prefix is added)
    }
